							...
							<section class="process-section anim-section text-center">
								...
								<div class="row processes">
									<div class="col-xs-12 col-sm-3">
										...
										<h3 class="h4">Basic Deatils</h3>
										<p>
											This Block takes the Basic information of User.
										</p>
									</div>
									<div class="col-xs-12 col-sm-3">
										<div class="process-step">
										...
										<h3 class="h4">Address Detail</h3>
										<p>
											This Block takes the Address and other Information of user.
										</p>
									</div>
									<div class="col-xs-12 col-sm-3">
										<div class="process-step">
										...
										<h3 class="h4">Help Details</h3>
										<p>
											This is to take the information for Helping When You are in Trouble.
										</p>
									</div>
									<div class="col-xs-12 col-sm-3">
										<div class="process-step">
										...
										<p>
											This Block is for user verification.
										</p>
									</div>
								</div>
								<p class="text-center">
									<a data-toggle="modal" href="#" data-target=".join-now-form" class="btn btn-default btn-lg join-today">JOIN TODAY</a>
								</p>
							</section>
					...
					<div class="modal-body">
						<form role="form" name="register" action="#" method="POST">
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12 col-sm-6">
										...
										<input type="text" class="form-control" name="name" id="name-join">
									</div>
									<div class="form-group col-xs-12 col-sm-6">
										<label for="last-name-join">Last Name<span>*</span></label>
										<input type="text" class="form-control" name="last_name" id="last-name-join">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12 col-sm-6">
										...
										<input type="text" class="form-control" name="email" id="email-join">
									</div>
									<div class="form-group col-xs-12 col-sm-6">
										<label for="phone-join">Phone<span>*</span></label>
										<input type="text" class="form-control" name="contact" id="phone-join">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12 col-sm-6">
										<label for="zip-code-join">Password<span>*</span></label>
										<input type="password" class="form-control" name="password" id="zip-code-join">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12">
										...
										<textarea class="form-control" id="message-join" name="reason"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group col-xs-12">
										<button type="button" name="submit" class="btn btn-default pull-right">
											Submit
										</button>
